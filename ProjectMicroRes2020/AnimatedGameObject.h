...
public:
	AnimatedGameObject(std::string id, const char* spriteName, unsigned int numFrames, unsigned int rowNum, unsigned int fps,
		...
		GameObject(id, spriteName, Entropy::Math::Vec2(0.0f, (float) rowNum), position, boxSize, boxOffset, textureOffset),
