...
public:
	Slime(Entropy::Math::Vec2 position, Entropy::Math::Vec3 color = Entropy::Math::Vec3(0.0f)) :
		AnimatedGameObject("Slime", "slime_sheet", 3, 0, 6, position, Entropy::Math::Vec2(8.0f, 8.0f),
