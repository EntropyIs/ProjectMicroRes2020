...
void StateCredits::render()
{
    Entropy::Math::Vec2 textPos[] =
    {
        ...
        Math::Vec2(7.5,  45.5), //J
        Math::Vec2(12.5, 45.5), //.
        Math::Vec2(17.5, 45.5), //P
        Math::Vec2(22.5, 45.5), //.
        Math::Vec2(27.5, 45.5), //G
        Math::Vec2(32.5, 45.5), //a
        Math::Vec2(37.5, 45.5), //l
        Math::Vec2(42.5, 45.5), //o
        Math::Vec2(47.5, 45.5), //v
        Math::Vec2(52.5, 45.5), //i
        Math::Vec2(57.5, 45.5), //c

        Math::Vec2(17.5, 37.5), //A
        Math::Vec2(22.5, 37.5), //n
        Math::Vec2(27.5, 37.5), //o
        Math::Vec2(32.5, 37.5), //n
        Math::Vec2(37.5, 37.5), //y
        Math::Vec2(42.5, 37.5), //9
        Math::Vec2(47.5, 37.5), //1

        Math::Vec2(14.5, 29.5), //X
        Math::Vec2(19.5, 29.5), //a
        Math::Vec2(24.5, 29.5), //n
        Math::Vec2(29.5, 29.5), //d
        Math::Vec2(34.5, 29.5), //a
        Math::Vec2(39.5, 29.5), //h
        Math::Vec2(44.5, 29.5), //a
        Math::Vec2(49.5, 29.5), //r
